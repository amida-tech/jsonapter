...
var prototype = {
    ...
    evaluateValue: function (value, input, parent, params, index) {
        ...
        if (valueType === 'function') {
            ...
            return this.runEngine(value, input, parent, params, index);
        } else {
            return value;
        }
    },
    ...
    content: function (template, input, parent, params, index) {
        var that = this;
        ...
        var result = keys.reduce(function (r, key) {
            ...
            var value = that.evaluateValue(contentValue, input, parent, params, index);
            if (value !== null) {
    ...
    assign: function (template, input, parent, params, index) {
        var templateAssign = template.assign;
        var that = this;
        var assignValues = templateAssign.reduce(function (r, assignValue) {
            var v = that.evaluateValue(assignValue, input, parent, params, index);
    ...
    template: function (template, input, parent, params, arrayIndex) {
        var templateValue = template.template;
        return this.evaluateValue(templateValue, input, parent, params, arrayIndex);
    },
    runForArray: function (template, input, parent, params) {
        ...
        var result = input.reduce(function (r, e) {
            var value = that.runEngine(modifiedTemplate, e, parent, params, index++);
            if (value !== null) {
                r.push(value);
            }
            return r;
    ...
    runEngine: function (template, input, parent, params, arrayIndex) {
        ...
        if ((input !== null) && (input !== undefined) && template.arrayIndex) {
        ...
        if (input !== null) {
            for (var i = 0; i < this.actionKeys.length; ++i) {
                ...
                if (template.hasOwnProperty(actionKey)) {
                    result = this[actionKey](template, input, parent, params, arrayIndex);
                    break;
                }
            }
        }
