...
var prototype = {
    ...
    paramKeyToInput: function (input, paramKey, params) {
        if (typeof params[paramKey] === 'function') {
            return params[paramKey](input, this.context);
        } else {
    ...
    evaluateParamKey: function (input, contextKey, context) {
        if (Array.isArray(contextKey)) {
            return this.dataKeyArrayToInput(input, contextKey);
        } else {
            return this.paramKeyToInput(input, contextKey, context);
        }
    },
