...
var prototype = {
    ...
    runEngine: function (template, input, parent, params, index) {
        ...
        if ((input !== null) && (input !== undefined) && template.arrayIndex) {
            return this.evaluateArrayIndex(index, template.arrayIndex);
        }
        if ((input !== null) && (input !== undefined) && template.size) {
            return this.evaluateSize(input, template.size);
        }
        ...
        if (input !== null) {
            for (var i = 0; i < this.actionKeys.length; ++i) {
                ...
                if (template.hasOwnProperty(actionKey)) {
                    result = this[actionKey](template, input, parent, params, index);
                    break;
                }
            }
        }
