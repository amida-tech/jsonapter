...
var prototype = {
    ...
    evaluateValue: function (value, input, parent, root, params, arrayIndex, arraySize, options, extraParams) {
        var that = this;
        var valueType = (typeof value);
        if (valueType === 'function') {
            return value(input, parent, root, params, extraParams);
            //if (parent && params) {
            ...
            return that.runEngine(value, input, parent, root, params, arrayIndex, arraySize, options, extraParams);
        } else {
            return value;
        }
    },
    ...
    content: function (template, input, parent, root, params, arrayIndex, arraySize, options, extraParams) {
        var that = this;
        ...
        var result = keys.reduce(function (r, key) {
            ...
            var value = that.evaluateValue(contentValue, input, parent, root, params, arrayIndex, arraySize, options, contentValue.params);
            if (value !== null) {
    ...
    timeStamp: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        if (!options.dateTime) {
    ...
    arrayContent: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        var that = this;
        ...
        var result = templatearrayContent.reduce(function (r, e) {
            var value = that.evaluateValue(e, input, parent, root, params, arrayIndex, arraySize);
            if (value !== null) {
                if (Array.isArray(value)) {
    ...
    assign: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        ...
        var assignValues = templateAssign.reduce(function (r, assignValue) {
            var v = that.evaluateValue(assignValue, input, parent, root, params, arrayIndex, arraySize, options);
    ...
    firstOf: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        ...
        var self = this;
        var value;
         _.find(templateFirstOf, function (t) {
            value = self.evaluateValue(t, input, parent, root, params, arrayIndex, arraySize, options);
            return value;
        });
        return value;
    },
    ...
    value: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        var templateValue = template.value;

        return _.isPlainObject(templateValue) ? _.get(templateValue, input) : this.evaluateValue(templateValue, input, parent, root, params, arrayIndex, arraySize, options, template.params);
    },
    template: function (template, input, parent, root, params, arrayIndex, arraySize, options) {
        ...
        return this.evaluateValue(templateValue, input, parent, root, params, arrayIndex, arraySize, options);
    },
    arrayIndex : function (template, input, parent, root, params, arrayIndex, arraySize) {
        return this.evaluateArrayIndex(arrayIndex, template.arrayIndex);
    },
    runForArray: function (template, input, parent, root, params, options) {
        ...
        var result = input.reduce(function (r, e) {
            var value = that.runEngine(modifiedTemplate, e, parent, root, params, index++, arrSize, options);
            if (value !== null) {
                r.push(value);
            }
            return r;
    ...
    run: function (template, input, params) {
        return this.runEngine(template, input, null, input, params);
    },
    runEngine: function (template, input, parent, root, params, arrayIndex, arraySize, options, extraParams) {
        ...
        if ((input !== null) && template.dataTransform) {
            ...
            if (_.isString(template.dataTransform)) {
                ...
                input = this.runEngine(template.dataTransform, input, parent, root, params, undefined, undefined, options);
            } else {
        ...
        if (Array.isArray(input)) {
            if (template.single) {
                ...
                var resultForArray = this.runForArray(template, input, parent, root, params, options);
        ...
        var result = input !== null && actionKey ? this[actionKey](template, input, parent, root, params, arrayIndex, arraySize, options, extraParams) : input;
