...
var prototype = {
    ...
    evaluateValue: function (value, input, parent, params, arrayIndex, arraySize, options) {
        var that = this;
        ...
        if (valueType === 'function') {
            ...
            return that.runEngine(value, input, parent, params, arrayIndex, arraySize, options);
        } else {
            return value;
        }
    },
    ...
    content: function (template, input, parent, params, arrayIndex, arraySize, options) {
        var that = this;
    ...
    runEngine: function (template, input, parent, params, arrayIndex, arraySize, options) {
